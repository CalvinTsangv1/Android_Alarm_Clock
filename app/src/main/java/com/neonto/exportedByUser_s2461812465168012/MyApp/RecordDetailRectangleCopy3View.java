...
public class RecordDetailRectangleCopy3View extends View {



    public RecordDetailRectangleCopy3View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public RecordDetailRectangleCopy3View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public RecordDetailRectangleCopy3View(Context context, AttributeSet attrs, int defStyle) {
