...
public class SetAlarmEllipseCopy24View extends View {



    public SetAlarmEllipseCopy24View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy24View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy24View(Context context, AttributeSet attrs, int defStyle) {
