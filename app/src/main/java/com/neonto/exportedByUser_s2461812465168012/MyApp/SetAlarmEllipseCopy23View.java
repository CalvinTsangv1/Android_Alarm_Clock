...
public class SetAlarmEllipseCopy23View extends View {



    public SetAlarmEllipseCopy23View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy23View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy23View(Context context, AttributeSet attrs, int defStyle) {
