...
public class GeneralSettingRectangleCopyView extends View {



    public GeneralSettingRectangleCopyView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public GeneralSettingRectangleCopyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public GeneralSettingRectangleCopyView(Context context, AttributeSet attrs, int defStyle) {
