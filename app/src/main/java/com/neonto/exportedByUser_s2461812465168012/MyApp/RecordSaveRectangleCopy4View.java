...
public class RecordSaveRectangleCopy4View extends View {



    public RecordSaveRectangleCopy4View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public RecordSaveRectangleCopy4View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public RecordSaveRectangleCopy4View(Context context, AttributeSet attrs, int defStyle) {
