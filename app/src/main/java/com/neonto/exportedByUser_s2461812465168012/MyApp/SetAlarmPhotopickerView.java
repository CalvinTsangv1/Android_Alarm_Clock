...
public class SetAlarmPhotopickerView extends ImageView {
    ...
    public SetAlarmPhotopickerView(Context context) {
        super(context);
        init(null, 0);
    }

    public SetAlarmPhotopickerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public SetAlarmPhotopickerView(Context context, AttributeSet attrs, int defStyle) {
