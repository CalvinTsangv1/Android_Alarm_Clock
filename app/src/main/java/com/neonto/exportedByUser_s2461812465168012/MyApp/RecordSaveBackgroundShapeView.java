...
public class RecordSaveBackgroundShapeView extends View {



    public RecordSaveBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public RecordSaveBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public RecordSaveBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
