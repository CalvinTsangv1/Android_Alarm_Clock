...
public class GeneralSettingRectangleCopy4View extends View {



    public GeneralSettingRectangleCopy4View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public GeneralSettingRectangleCopy4View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public GeneralSettingRectangleCopy4View(Context context, AttributeSet attrs, int defStyle) {
