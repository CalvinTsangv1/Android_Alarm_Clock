...
public class SetAlarmEllipseCopy3View extends View {



    public SetAlarmEllipseCopy3View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy3View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy3View(Context context, AttributeSet attrs, int defStyle) {
