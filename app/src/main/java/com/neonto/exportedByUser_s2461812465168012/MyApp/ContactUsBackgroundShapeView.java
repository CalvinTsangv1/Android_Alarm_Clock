...
public class ContactUsBackgroundShapeView extends View {



    public ContactUsBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public ContactUsBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public ContactUsBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
