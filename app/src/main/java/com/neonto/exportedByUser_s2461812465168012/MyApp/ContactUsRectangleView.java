...
public class ContactUsRectangleView extends View {



    public ContactUsRectangleView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public ContactUsRectangleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public ContactUsRectangleView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.scale(m_realLayoutWidthInPx/720.0f, m_realLayoutHeightInPx/2.125167336f);
        canvas.translate(360.0f, 1.062583668f);
        path = new Path();
        path.moveTo(-360.0f, -1.06f);
          path.lineTo(360.0f, -1.06f);
        path.lineTo(360.0f, 1.06f);
        path.lineTo(-360.0f, 1.06f);
