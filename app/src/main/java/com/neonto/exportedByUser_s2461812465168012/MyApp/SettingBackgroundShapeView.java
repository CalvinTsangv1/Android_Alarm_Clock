...
public class SettingBackgroundShapeView extends View {



    public SettingBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SettingBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SettingBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
