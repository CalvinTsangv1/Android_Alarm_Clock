...
public class SettingRectangleCopyView extends View {



    public SettingRectangleCopyView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SettingRectangleCopyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SettingRectangleCopyView(Context context, AttributeSet attrs, int defStyle) {
