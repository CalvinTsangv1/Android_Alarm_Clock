...
public class AlarmSettingRectangleCopy5View extends View {



    public AlarmSettingRectangleCopy5View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public AlarmSettingRectangleCopy5View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public AlarmSettingRectangleCopy5View(Context context, AttributeSet attrs, int defStyle) {
