...
public class AlarmSettingRectangleView extends View {



    public AlarmSettingRectangleView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public AlarmSettingRectangleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public AlarmSettingRectangleView(Context context, AttributeSet attrs, int defStyle) {
