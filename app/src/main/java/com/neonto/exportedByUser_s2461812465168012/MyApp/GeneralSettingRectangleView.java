...
public class GeneralSettingRectangleView extends View {



    public GeneralSettingRectangleView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public GeneralSettingRectangleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public GeneralSettingRectangleView(Context context, AttributeSet attrs, int defStyle) {
