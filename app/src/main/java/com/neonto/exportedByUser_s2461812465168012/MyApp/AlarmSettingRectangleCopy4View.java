...
public class AlarmSettingRectangleCopy4View extends View {



    public AlarmSettingRectangleCopy4View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public AlarmSettingRectangleCopy4View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public AlarmSettingRectangleCopy4View(Context context, AttributeSet attrs, int defStyle) {
