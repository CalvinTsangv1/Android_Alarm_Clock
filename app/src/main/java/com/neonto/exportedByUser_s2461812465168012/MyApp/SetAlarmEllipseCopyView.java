...
public class SetAlarmEllipseCopyView extends View {



    public SetAlarmEllipseCopyView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopyView(Context context, AttributeSet attrs, int defStyle) {
