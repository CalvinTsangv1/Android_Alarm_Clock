...
public class SetAlarmEllipseCopy8View extends View {



    public SetAlarmEllipseCopy8View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy8View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy8View(Context context, AttributeSet attrs, int defStyle) {
