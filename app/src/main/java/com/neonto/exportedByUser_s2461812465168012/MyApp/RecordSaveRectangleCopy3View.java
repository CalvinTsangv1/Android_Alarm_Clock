...
public class RecordSaveRectangleCopy3View extends View {



    public RecordSaveRectangleCopy3View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public RecordSaveRectangleCopy3View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public RecordSaveRectangleCopy3View(Context context, AttributeSet attrs, int defStyle) {
