...
public class StopWatchListItemRectangleView extends View {



    public StopWatchListItemRectangleView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public StopWatchListItemRectangleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public StopWatchListItemRectangleView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.scale(m_realLayoutWidthInPx/216.0f, m_realLayoutHeightInPx/2.125167336f);
        canvas.translate(108.0f, 1.062583668f);
        path = new Path();
        path.moveTo(-108.0f, -1.06f);
          path.lineTo(108.0f, -1.06f);
        path.lineTo(108.0f, 1.06f);
        path.lineTo(-108.0f, 1.06f);
