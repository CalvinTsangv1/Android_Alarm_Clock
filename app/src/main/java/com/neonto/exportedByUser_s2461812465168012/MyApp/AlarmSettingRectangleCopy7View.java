...
public class AlarmSettingRectangleCopy7View extends View {



    public AlarmSettingRectangleCopy7View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public AlarmSettingRectangleCopy7View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public AlarmSettingRectangleCopy7View(Context context, AttributeSet attrs, int defStyle) {
