...
public class SetAlarmEllipseCopy5View extends View {



    public SetAlarmEllipseCopy5View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy5View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy5View(Context context, AttributeSet attrs, int defStyle) {
