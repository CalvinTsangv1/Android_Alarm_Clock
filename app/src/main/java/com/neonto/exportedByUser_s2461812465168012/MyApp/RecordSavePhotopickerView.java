...
public class RecordSavePhotopickerView extends ImageView {
    ...
    public RecordSavePhotopickerView(Context context) {
        super(context);
        init(null, 0);
    }

    public RecordSavePhotopickerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public RecordSavePhotopickerView(Context context, AttributeSet attrs, int defStyle) {
