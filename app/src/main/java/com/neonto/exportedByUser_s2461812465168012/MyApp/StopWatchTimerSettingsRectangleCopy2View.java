...
public class StopWatchTimerSettingsRectangleCopy2View extends View {



    public StopWatchTimerSettingsRectangleCopy2View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public StopWatchTimerSettingsRectangleCopy2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public StopWatchTimerSettingsRectangleCopy2View(Context context, AttributeSet attrs, int defStyle) {
