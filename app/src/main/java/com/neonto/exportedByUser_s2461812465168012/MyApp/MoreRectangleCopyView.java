...
public class MoreRectangleCopyView extends View {



    public MoreRectangleCopyView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public MoreRectangleCopyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public MoreRectangleCopyView(Context context, AttributeSet attrs, int defStyle) {
