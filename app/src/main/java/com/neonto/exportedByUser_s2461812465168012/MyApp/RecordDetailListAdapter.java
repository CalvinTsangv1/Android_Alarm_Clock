...
public class RecordDetailListAdapter extends BaseAdapter {
    ...
    public RecordDetailListAdapter(Fragment owner) {
        mOwner = owner;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        layoutDescs.add(new LayoutDesc(10, 0.0f, 60.0f, LayoutDesc.NO_VALUE, 676.0f, 2.13f));  // 720*1280 px
        layoutDescs.add(new LayoutDesc(2, 0.0f, 26.0f, LayoutDesc.NO_VALUE, 226.0f, 0.92f));  // 240*320 px
        layoutDescs.add(new LayoutDesc(12, 0.0f, 75.0f, LayoutDesc.NO_VALUE, 1016.0f, 2.68f));  // 1080*1920 px
        layoutDescs.add(new LayoutDesc(8, 0.0f, 42.0f, LayoutDesc.NO_VALUE, 452.0f, 1.51f));  // 480*800 px
        elementDesc.put("layoutDescs", layoutDescs);
        overrides.put("rectangle", elementDesc);
        
        elementDesc = new HashMap();
        layoutDescs = new ArrayList<LayoutDesc>();
        layoutDescs.add(new LayoutDesc(10, 420.98f, 0.0f, LayoutDesc.NO_VALUE, 255.02f, 49.0f));  // 720*1280 px
        layoutDescs.add(new LayoutDesc(2, 115.16f, 0.0f, LayoutDesc.NO_VALUE, 110.84f, 25.0f));  // 240*320 px
        layoutDescs.add(new LayoutDesc(12, 694.35f, 0.0f, LayoutDesc.NO_VALUE, 321.65f, 60.0f));  // 1080*1920 px
        layoutDescs.add(new LayoutDesc(8, 271.15f, 0.0f, LayoutDesc.NO_VALUE, 180.85f, 37.0f));  // 480*800 px
        elementDesc.put("layoutDescs", layoutDescs);
        ...
        layoutDescs.add(new LayoutDesc(12, 20.0f, 0.0f, LayoutDesc.NO_VALUE, 160.83f, 71.0f));  // 1080*1920 px
        layoutDescs.add(new LayoutDesc(8, 9.0f, 0.0f, LayoutDesc.NO_VALUE, 90.42f, 43.0f));  // 480*800 px
        elementDesc.put("layoutDescs", layoutDescs);
        overrides.put("text", elementDesc);
        
        elementDesc = new HashMap();
        layoutDescs = new ArrayList<LayoutDesc>();
        layoutDescs.add(new LayoutDesc(10, 0.0f, 0.0f, 0.0f, 676.0f, 96.0f));  // 720*1280 px
        layoutDescs.add(new LayoutDesc(2, 0.0f, 0.0f, 0.0f, 226.0f, 42.0f));  // 240*320 px
        layoutDescs.add(new LayoutDesc(12, 0.0f, 0.0f, 0.0f, 1016.0f, 121.0f));  // 1080*1920 px
        layoutDescs.add(new LayoutDesc(8, 0.0f, 0.0f, 0.0f, 452.0f, 68.0f));  // 480*800 px
        elementDesc.put("layoutDescs", layoutDescs);
