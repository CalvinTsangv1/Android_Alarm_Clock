...
public class RecordDetailRectangleView extends View {



    public RecordDetailRectangleView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public RecordDetailRectangleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public RecordDetailRectangleView(Context context, AttributeSet attrs, int defStyle) {
