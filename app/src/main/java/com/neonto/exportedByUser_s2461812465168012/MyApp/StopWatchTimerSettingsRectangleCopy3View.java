...
public class StopWatchTimerSettingsRectangleCopy3View extends View {



    public StopWatchTimerSettingsRectangleCopy3View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public StopWatchTimerSettingsRectangleCopy3View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public StopWatchTimerSettingsRectangleCopy3View(Context context, AttributeSet attrs, int defStyle) {
