...
public class AlarmSettingImageView extends FrameLayout {



    private ImageView m_image;
    // This value represents scaling applied to the image by Neonto Studio on export.
    private float m_contentOriginalScale = 0.184761905f;
    ...
    public AlarmSettingImageView(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public AlarmSettingImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public AlarmSettingImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.alarm_setting_image);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        float maskCornerRadius = Math.min(w, h) * 0.05f;
