...
public class SetAlarmEllipseView extends View {



    public SetAlarmEllipseView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseView(Context context, AttributeSet attrs, int defStyle) {
