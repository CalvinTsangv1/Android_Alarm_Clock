...
public class StopWatchTimerSettingsRectangleCopy6View extends View {



    public StopWatchTimerSettingsRectangleCopy6View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public StopWatchTimerSettingsRectangleCopy6View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public StopWatchTimerSettingsRectangleCopy6View(Context context, AttributeSet attrs, int defStyle) {
