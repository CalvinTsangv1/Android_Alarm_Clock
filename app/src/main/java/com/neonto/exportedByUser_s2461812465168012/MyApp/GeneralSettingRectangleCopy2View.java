...
public class GeneralSettingRectangleCopy2View extends View {



    public GeneralSettingRectangleCopy2View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public GeneralSettingRectangleCopy2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public GeneralSettingRectangleCopy2View(Context context, AttributeSet attrs, int defStyle) {
