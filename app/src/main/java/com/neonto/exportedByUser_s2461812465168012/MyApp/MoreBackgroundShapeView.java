...
public class MoreBackgroundShapeView extends View {



    public MoreBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public MoreBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public MoreBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
