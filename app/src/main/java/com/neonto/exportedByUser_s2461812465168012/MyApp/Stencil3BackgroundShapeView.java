...
public class Stencil3BackgroundShapeView extends View {



    public Stencil3BackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public Stencil3BackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public Stencil3BackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.scale(m_realLayoutWidthInPx/290.0f, m_realLayoutHeightInPx/287.0f);
        canvas.translate(145.0f, 143.5f);
        path = new Path();
        path.moveTo(-145.0f, -143.5f);
          path.lineTo(145.0f, -143.5f);
        path.lineTo(145.0f, 143.5f);
        path.lineTo(-145.0f, 143.5f);
