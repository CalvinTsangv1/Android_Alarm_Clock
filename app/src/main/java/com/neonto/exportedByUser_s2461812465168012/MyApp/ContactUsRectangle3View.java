...
public class ContactUsRectangle3View extends View {



    public ContactUsRectangle3View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public ContactUsRectangle3View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public ContactUsRectangle3View(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        if (s_paths == null) {
            ...
            s_paths[0].moveTo(-349.5f, -33.0f);
              s_paths[0].lineTo(356.5f, -33.0f);
            s_paths[0].lineTo(356.5f, 30.76f);
            s_paths[0].lineTo(-349.5f, 30.76f);
