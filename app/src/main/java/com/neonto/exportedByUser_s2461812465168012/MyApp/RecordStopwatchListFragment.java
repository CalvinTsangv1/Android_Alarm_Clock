...
public class RecordStopwatchListFragment extends Fragment {

    private RecordStopwatchListBackgroundShapeView mBackgroundShape;
    private ListView mList;
    private RecordStopwatchListListAdapter mListAdapter;
    ...
    public RecordStopwatchListFragment() {  // fragment must have a constructor
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_record_stopwatch_list, container, false);
                
        mBackgroundShape = (RecordStopwatchListBackgroundShapeView) rootView.findViewById(R.id.mBackgroundShape);
        mList = (ListView) rootView.findViewById(R.id.mList);
        final RecordStopwatchListFragment fragment = this;

        final Context context = getActivity().getBaseContext();
        
        
        final RecordStopwatchListListAdapter recordStopwatchListListAdapter = new RecordStopwatchListListAdapter(this);
        recordStopwatchListListAdapter.setDataSheet(AppData.stopwatchSaveDataSheet);
        mList.setAdapter(recordStopwatchListListAdapter);
        mListAdapter = recordStopwatchListListAdapter;
        
        AppData.stopwatchSaveDataSheet.addListener(new DataSheet.OnChangeListener() {
           @Override
           public void dataSheetUpdated(DataSheet sheet) {
               recordStopwatchListListAdapter.notifyDataSetChanged();
           }
        });
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        actionBar.setHomeAsUpIndicator(R.drawable.button_icon991448);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                intent.putExtra("tabIndex", 2);getActivity().startActivity(intent);
                return true;
        }
        return false;
    }
        ...
        
        {
            ...
            if (val != null) {
                ...
                if (type.equals("json") && (value instanceof org.json.JSONArray)) {
                    ...
                    ((RecordStopwatchListListAdapter) mList.getAdapter()).setDataSheet(sheet);
                    ((RecordStopwatchListListAdapter) mList.getAdapter()).notifyDataSetChanged();
                }
            }
        }
