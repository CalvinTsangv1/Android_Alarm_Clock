...
public class SetAlarmEllipseCopy10View extends View {



    public SetAlarmEllipseCopy10View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy10View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy10View(Context context, AttributeSet attrs, int defStyle) {
