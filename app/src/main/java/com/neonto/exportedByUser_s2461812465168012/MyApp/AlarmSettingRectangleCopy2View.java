...
public class AlarmSettingRectangleCopy2View extends View {



    public AlarmSettingRectangleCopy2View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public AlarmSettingRectangleCopy2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public AlarmSettingRectangleCopy2View(Context context, AttributeSet attrs, int defStyle) {
