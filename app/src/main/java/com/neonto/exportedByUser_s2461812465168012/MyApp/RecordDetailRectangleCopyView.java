...
public class RecordDetailRectangleCopyView extends View {



    public RecordDetailRectangleCopyView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public RecordDetailRectangleCopyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public RecordDetailRectangleCopyView(Context context, AttributeSet attrs, int defStyle) {
