...
public class SetAlarmEllipseCopy30View extends View {



    public SetAlarmEllipseCopy30View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy30View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy30View(Context context, AttributeSet attrs, int defStyle) {
