...
public class SetAlarmRectangleView extends View {



    public SetAlarmRectangleView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmRectangleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmRectangleView(Context context, AttributeSet attrs, int defStyle) {
