...
public class AlarmBackgroundShapeView extends View {



    public AlarmBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public AlarmBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public AlarmBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
