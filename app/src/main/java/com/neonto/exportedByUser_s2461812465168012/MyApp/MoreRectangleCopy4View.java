...
public class MoreRectangleCopy4View extends View {



    public MoreRectangleCopy4View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public MoreRectangleCopy4View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public MoreRectangleCopy4View(Context context, AttributeSet attrs, int defStyle) {
