...
public class SetAlarmEllipseCopy29View extends View {



    public SetAlarmEllipseCopy29View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy29View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy29View(Context context, AttributeSet attrs, int defStyle) {
