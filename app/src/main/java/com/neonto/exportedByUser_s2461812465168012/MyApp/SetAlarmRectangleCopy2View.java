...
public class SetAlarmRectangleCopy2View extends View {



    public SetAlarmRectangleCopy2View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmRectangleCopy2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmRectangleCopy2View(Context context, AttributeSet attrs, int defStyle) {
