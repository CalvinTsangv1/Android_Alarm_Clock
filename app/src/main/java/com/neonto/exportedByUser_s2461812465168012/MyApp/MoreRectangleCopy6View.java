...
public class MoreRectangleCopy6View extends View {



    public MoreRectangleCopy6View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public MoreRectangleCopy6View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public MoreRectangleCopy6View(Context context, AttributeSet attrs, int defStyle) {
