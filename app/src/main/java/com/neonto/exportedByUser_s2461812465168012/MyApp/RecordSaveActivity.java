...
public class RecordSaveActivity extends android.support.v7.app.ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getFragmentManager().beginTransaction()
                    .add(R.id.container, new RecordSaveFragment())
                    .commit();
        }

        setTitle(getString(R.string.record_save_title));
    }
