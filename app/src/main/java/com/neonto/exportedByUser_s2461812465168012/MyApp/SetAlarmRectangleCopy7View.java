...
public class SetAlarmRectangleCopy7View extends View {



    public SetAlarmRectangleCopy7View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmRectangleCopy7View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmRectangleCopy7View(Context context, AttributeSet attrs, int defStyle) {
