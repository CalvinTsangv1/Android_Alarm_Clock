...
public class RecordDetailRectangleCopy2View extends View {



    public RecordDetailRectangleCopy2View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public RecordDetailRectangleCopy2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public RecordDetailRectangleCopy2View(Context context, AttributeSet attrs, int defStyle) {
