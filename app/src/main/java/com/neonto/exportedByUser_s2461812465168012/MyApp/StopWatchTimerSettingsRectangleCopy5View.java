...
public class StopWatchTimerSettingsRectangleCopy5View extends View {



    public StopWatchTimerSettingsRectangleCopy5View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public StopWatchTimerSettingsRectangleCopy5View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public StopWatchTimerSettingsRectangleCopy5View(Context context, AttributeSet attrs, int defStyle) {
