...
public class GeneralSettingActivity extends android.support.v7.app.ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getFragmentManager().beginTransaction()
                    .add(R.id.container, new GeneralSettingFragment())
                    .commit();
        }

        setTitle(getString(R.string.general_setting_title));
    }
