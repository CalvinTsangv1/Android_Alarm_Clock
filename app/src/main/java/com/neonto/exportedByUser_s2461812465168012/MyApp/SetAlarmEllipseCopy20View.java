...
public class SetAlarmEllipseCopy20View extends View {



    public SetAlarmEllipseCopy20View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy20View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy20View(Context context, AttributeSet attrs, int defStyle) {
