...
public class GeneralSettingRectangleCopy3View extends View {



    public GeneralSettingRectangleCopy3View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public GeneralSettingRectangleCopy3View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public GeneralSettingRectangleCopy3View(Context context, AttributeSet attrs, int defStyle) {
