...
public class Stencil7BackgroundShapeView extends View {



    public Stencil7BackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public Stencil7BackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public Stencil7BackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        if (s_paths == null) {
            ...
            s_paths[0].moveTo(0.0f, 0.0f);
              s_paths[0].lineTo(223.0f, 0.0f);
            s_paths[0].lineTo(223.0f, 569.0f);
            s_paths[0].lineTo(0.0f, 569.0f);
