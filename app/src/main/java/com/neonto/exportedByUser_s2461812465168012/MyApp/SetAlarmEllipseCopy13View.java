...
public class SetAlarmEllipseCopy13View extends View {



    public SetAlarmEllipseCopy13View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy13View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy13View(Context context, AttributeSet attrs, int defStyle) {
