...
public class SetAlarmEllipseCopy16View extends View {



    public SetAlarmEllipseCopy16View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy16View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy16View(Context context, AttributeSet attrs, int defStyle) {
