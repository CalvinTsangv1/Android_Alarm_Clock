...
public class SetAlarmRectangleCopy3View extends View {



    public SetAlarmRectangleCopy3View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmRectangleCopy3View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmRectangleCopy3View(Context context, AttributeSet attrs, int defStyle) {
