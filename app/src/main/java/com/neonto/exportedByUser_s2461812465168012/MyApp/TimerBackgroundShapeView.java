...
public class TimerBackgroundShapeView extends View {



    public TimerBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public TimerBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public TimerBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
