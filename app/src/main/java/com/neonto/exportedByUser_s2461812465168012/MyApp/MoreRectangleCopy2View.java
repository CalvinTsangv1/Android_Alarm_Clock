...
public class MoreRectangleCopy2View extends View {



    public MoreRectangleCopy2View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public MoreRectangleCopy2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public MoreRectangleCopy2View(Context context, AttributeSet attrs, int defStyle) {
