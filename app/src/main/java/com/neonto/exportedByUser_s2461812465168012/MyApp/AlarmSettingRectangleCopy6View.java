...
public class AlarmSettingRectangleCopy6View extends View {



    public AlarmSettingRectangleCopy6View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public AlarmSettingRectangleCopy6View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public AlarmSettingRectangleCopy6View(Context context, AttributeSet attrs, int defStyle) {
