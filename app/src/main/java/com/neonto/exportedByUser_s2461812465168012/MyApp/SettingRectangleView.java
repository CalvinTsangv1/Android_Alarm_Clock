...
public class SettingRectangleView extends View {



    public SettingRectangleView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SettingRectangleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SettingRectangleView(Context context, AttributeSet attrs, int defStyle) {
