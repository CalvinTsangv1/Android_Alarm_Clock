...
public class SetAlarmEllipseCopy4View extends View {



    public SetAlarmEllipseCopy4View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy4View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy4View(Context context, AttributeSet attrs, int defStyle) {
