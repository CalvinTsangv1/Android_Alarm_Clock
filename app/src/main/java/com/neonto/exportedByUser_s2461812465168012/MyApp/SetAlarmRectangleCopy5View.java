...
public class SetAlarmRectangleCopy5View extends View {



    public SetAlarmRectangleCopy5View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmRectangleCopy5View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmRectangleCopy5View(Context context, AttributeSet attrs, int defStyle) {
