...
public class SetAlarmEllipseCopy22View extends View {



    public SetAlarmEllipseCopy22View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy22View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy22View(Context context, AttributeSet attrs, int defStyle) {
