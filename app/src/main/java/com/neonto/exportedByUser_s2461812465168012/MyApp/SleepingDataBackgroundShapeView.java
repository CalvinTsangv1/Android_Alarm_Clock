...
public class SleepingDataBackgroundShapeView extends View {



    public SleepingDataBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SleepingDataBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SleepingDataBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
