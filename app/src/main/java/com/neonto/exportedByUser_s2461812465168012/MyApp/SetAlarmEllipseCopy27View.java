...
public class SetAlarmEllipseCopy27View extends View {



    public SetAlarmEllipseCopy27View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy27View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy27View(Context context, AttributeSet attrs, int defStyle) {
