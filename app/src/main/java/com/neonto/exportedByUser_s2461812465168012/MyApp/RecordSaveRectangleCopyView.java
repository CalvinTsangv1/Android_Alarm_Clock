...
public class RecordSaveRectangleCopyView extends View {



    public RecordSaveRectangleCopyView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public RecordSaveRectangleCopyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public RecordSaveRectangleCopyView(Context context, AttributeSet attrs, int defStyle) {
