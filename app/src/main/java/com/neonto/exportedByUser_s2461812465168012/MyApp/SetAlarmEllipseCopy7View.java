...
public class SetAlarmEllipseCopy7View extends View {



    public SetAlarmEllipseCopy7View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy7View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy7View(Context context, AttributeSet attrs, int defStyle) {
