...
public class MoreRectangleView extends View {



    public MoreRectangleView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public MoreRectangleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public MoreRectangleView(Context context, AttributeSet attrs, int defStyle) {
