...
public class MoreRectangleCopy7View extends View {



    public MoreRectangleCopy7View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public MoreRectangleCopy7View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public MoreRectangleCopy7View(Context context, AttributeSet attrs, int defStyle) {
