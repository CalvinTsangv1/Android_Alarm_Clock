...
public class RecordSaveRectangleCopy2View extends View {



    public RecordSaveRectangleCopy2View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public RecordSaveRectangleCopy2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public RecordSaveRectangleCopy2View(Context context, AttributeSet attrs, int defStyle) {
