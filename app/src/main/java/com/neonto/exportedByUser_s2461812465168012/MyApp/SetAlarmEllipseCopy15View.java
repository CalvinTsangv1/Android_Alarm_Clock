...
public class SetAlarmEllipseCopy15View extends View {



    public SetAlarmEllipseCopy15View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy15View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy15View(Context context, AttributeSet attrs, int defStyle) {
