...
public class SetAlarmEllipseCopy6View extends View {



    public SetAlarmEllipseCopy6View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy6View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy6View(Context context, AttributeSet attrs, int defStyle) {
