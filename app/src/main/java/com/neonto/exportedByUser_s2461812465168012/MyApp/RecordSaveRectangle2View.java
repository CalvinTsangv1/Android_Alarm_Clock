...
public class RecordSaveRectangle2View extends View {



    public RecordSaveRectangle2View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public RecordSaveRectangle2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public RecordSaveRectangle2View(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        if (s_paths == null) {
            ...
            s_paths[0].moveTo(-289.5f, -158.5f);
              s_paths[0].lineTo(286.5f, -158.5f);
            s_paths[0].lineTo(286.5f, 72.42f);
            s_paths[0].lineTo(-289.5f, 72.42f);
            
            s_paths[0].close();
            s_paints[0] = new Paint(Paint.ANTI_ALIAS_FLAG);
            s_paints[0].setStyle(Paint.Style.FILL);
            s_paints[0].setARGB(0, 0, 0, 0);
        }
