...
public class SetAlarmEllipseCopy19View extends View {



    public SetAlarmEllipseCopy19View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy19View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy19View(Context context, AttributeSet attrs, int defStyle) {
