...
public class RecordStopwatchListItemBackgroundShapeView extends View {



    public RecordStopwatchListItemBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public RecordStopwatchListItemBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public RecordStopwatchListItemBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        if (s_paths == null) {
            ...
            s_paths[0].moveTo(0.0f, 0.0f);
              s_paths[0].lineTo(180.0f, 0.0f);
            s_paths[0].lineTo(180.0f, 297.0f);
            s_paths[0].lineTo(0.0f, 297.0f);
            
            s_paths[0].close();
            s_paints[0] = new Paint(Paint.ANTI_ALIAS_FLAG);
            s_paints[0].setStyle(Paint.Style.FILL);
            s_paints[0].setARGB(255, 255, 255, 255);
        }
