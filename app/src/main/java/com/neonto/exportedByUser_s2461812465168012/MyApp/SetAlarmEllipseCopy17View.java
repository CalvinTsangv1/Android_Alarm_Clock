...
public class SetAlarmEllipseCopy17View extends View {



    public SetAlarmEllipseCopy17View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy17View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy17View(Context context, AttributeSet attrs, int defStyle) {
