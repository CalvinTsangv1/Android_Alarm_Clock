...
public class AlarmSettingRectangleCopy3View extends View {



    public AlarmSettingRectangleCopy3View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public AlarmSettingRectangleCopy3View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public AlarmSettingRectangleCopy3View(Context context, AttributeSet attrs, int defStyle) {
