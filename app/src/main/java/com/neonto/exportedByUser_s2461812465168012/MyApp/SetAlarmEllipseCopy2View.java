...
public class SetAlarmEllipseCopy2View extends View {



    public SetAlarmEllipseCopy2View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy2View(Context context, AttributeSet attrs, int defStyle) {
