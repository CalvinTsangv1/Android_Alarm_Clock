...
public class SetAlarmEllipseCopy18View extends View {



    public SetAlarmEllipseCopy18View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy18View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy18View(Context context, AttributeSet attrs, int defStyle) {
