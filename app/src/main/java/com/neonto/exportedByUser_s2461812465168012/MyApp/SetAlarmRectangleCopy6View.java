...
public class SetAlarmRectangleCopy6View extends View {



    public SetAlarmRectangleCopy6View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmRectangleCopy6View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmRectangleCopy6View(Context context, AttributeSet attrs, int defStyle) {
