...
public class SetAlarmEllipseCopy28View extends View {



    public SetAlarmEllipseCopy28View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy28View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy28View(Context context, AttributeSet attrs, int defStyle) {
