...
public class GeneralSettingRectangleCopy5View extends View {



    public GeneralSettingRectangleCopy5View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public GeneralSettingRectangleCopy5View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public GeneralSettingRectangleCopy5View(Context context, AttributeSet attrs, int defStyle) {
