...
public class SetAlarmEllipseCopy11View extends View {



    public SetAlarmEllipseCopy11View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy11View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy11View(Context context, AttributeSet attrs, int defStyle) {
