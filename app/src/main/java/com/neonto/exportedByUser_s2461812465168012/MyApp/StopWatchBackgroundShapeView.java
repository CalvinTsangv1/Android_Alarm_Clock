...
public class StopWatchBackgroundShapeView extends View {



    public StopWatchBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public StopWatchBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public StopWatchBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
