...
public class SetAlarmEllipseCopy26View extends View {



    public SetAlarmEllipseCopy26View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy26View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy26View(Context context, AttributeSet attrs, int defStyle) {
