...
public class SetAlarmRectangleCopy4View extends View {



    public SetAlarmRectangleCopy4View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmRectangleCopy4View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmRectangleCopy4View(Context context, AttributeSet attrs, int defStyle) {
