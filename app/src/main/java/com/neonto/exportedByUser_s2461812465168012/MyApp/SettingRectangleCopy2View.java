...
public class SettingRectangleCopy2View extends View {



    public SettingRectangleCopy2View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SettingRectangleCopy2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SettingRectangleCopy2View(Context context, AttributeSet attrs, int defStyle) {
