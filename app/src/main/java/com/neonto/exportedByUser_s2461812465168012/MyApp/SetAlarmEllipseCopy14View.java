...
public class SetAlarmEllipseCopy14View extends View {



    public SetAlarmEllipseCopy14View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy14View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy14View(Context context, AttributeSet attrs, int defStyle) {
