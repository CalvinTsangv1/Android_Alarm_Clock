...
public class SetAlarmEllipseCopy21View extends View {



    public SetAlarmEllipseCopy21View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy21View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy21View(Context context, AttributeSet attrs, int defStyle) {
