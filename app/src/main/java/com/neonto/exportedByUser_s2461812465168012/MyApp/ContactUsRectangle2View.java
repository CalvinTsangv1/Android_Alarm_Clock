...
public class ContactUsRectangle2View extends View {



    public ContactUsRectangle2View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public ContactUsRectangle2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public ContactUsRectangle2View(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        if (s_paths == null) {
            ...
            s_paths[0].moveTo(-339.0f, -309.0f);
              s_paths[0].lineTo(353.0f, -309.0f);
            s_paths[0].lineTo(353.0f, 353.02f);
            s_paths[0].lineTo(-339.0f, 353.02f);
