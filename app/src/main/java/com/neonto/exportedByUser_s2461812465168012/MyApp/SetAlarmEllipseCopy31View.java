...
public class SetAlarmEllipseCopy31View extends View {



    public SetAlarmEllipseCopy31View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy31View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy31View(Context context, AttributeSet attrs, int defStyle) {
