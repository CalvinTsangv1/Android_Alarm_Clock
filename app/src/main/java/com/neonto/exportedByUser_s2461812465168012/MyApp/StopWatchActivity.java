...
public class StopWatchActivity extends android.support.v7.app.ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getFragmentManager().beginTransaction()
                    .add(R.id.container, new StopWatchFragment())
                    .commit();
        }

        setTitle(getString(R.string.stop_watch_title));
    }
