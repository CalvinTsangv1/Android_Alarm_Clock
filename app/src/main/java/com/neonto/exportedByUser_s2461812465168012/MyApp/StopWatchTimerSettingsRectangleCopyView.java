...
public class StopWatchTimerSettingsRectangleCopyView extends View {



    public StopWatchTimerSettingsRectangleCopyView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public StopWatchTimerSettingsRectangleCopyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public StopWatchTimerSettingsRectangleCopyView(Context context, AttributeSet attrs, int defStyle) {
