...
public class AlarmSettingRectangleCopyView extends View {



    public AlarmSettingRectangleCopyView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public AlarmSettingRectangleCopyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public AlarmSettingRectangleCopyView(Context context, AttributeSet attrs, int defStyle) {
