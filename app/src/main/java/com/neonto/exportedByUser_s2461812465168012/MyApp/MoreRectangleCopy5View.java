...
public class MoreRectangleCopy5View extends View {



    public MoreRectangleCopy5View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public MoreRectangleCopy5View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public MoreRectangleCopy5View(Context context, AttributeSet attrs, int defStyle) {
