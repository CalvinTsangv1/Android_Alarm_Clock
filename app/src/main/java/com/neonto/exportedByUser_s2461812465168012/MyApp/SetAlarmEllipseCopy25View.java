...
public class SetAlarmEllipseCopy25View extends View {



    public SetAlarmEllipseCopy25View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmEllipseCopy25View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmEllipseCopy25View(Context context, AttributeSet attrs, int defStyle) {
