...
public class SetAlarmBackgroundShapeView extends View {



    public SetAlarmBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SetAlarmBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SetAlarmBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
