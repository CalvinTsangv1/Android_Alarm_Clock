...
public class MoreRectangleCopy8View extends View {



    public MoreRectangleCopy8View(Context context) {
        super(context);
        init(null, 0);
    }
    
    public MoreRectangleCopy8View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public MoreRectangleCopy8View(Context context, AttributeSet attrs, int defStyle) {
