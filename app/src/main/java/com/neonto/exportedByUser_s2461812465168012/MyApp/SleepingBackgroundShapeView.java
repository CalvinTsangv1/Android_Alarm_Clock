...
public class SleepingBackgroundShapeView extends View {



    public SleepingBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public SleepingBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public SleepingBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
